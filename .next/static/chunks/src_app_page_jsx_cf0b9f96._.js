...
(()=>{
    const e = new Error("Cannot find module 'src/components/ui/button'");
    e.code = 'MODULE_NOT_FOUND';
    throw e;
})();
(()=>{
...
(()=>{
    const e = new Error("Cannot find module 'src/components/ui/footer'");
    e.code = 'MODULE_NOT_FOUND';
    throw e;
})();
(()=>{
    const e = new Error("Cannot find module 'src/components/ui/background'");
    e.code = 'MODULE_NOT_FOUND';
    throw e;
})();
;
...
_c = MotionDiv;
const MotionCard = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$framer$2d$motion$2f$dist$2f$es$2f$render$2f$components$2f$motion$2f$proxy$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["motion"].create(Card);
_c1 = MotionCard;
function Home() {
    _s();
